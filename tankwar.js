...
board.addEventListener("mousemove", function(event){
    ...
    if (!paused && !mainy) {
		player.turret.targetAngle = Math.atan2(event.x - board.offsetLeft - player.posX*3/4, player.posY*3/4 + board.offsetTop - event.y);	
	}
	else if (mainy) {
		c2.font="70px Verdana";
	    if (event.x - board.offsetLeft > 650*3/4 && event.x - board.offsetLeft < 1050*3/4 && event.y - board.offsetTop > 350*3/4 && event.y - board.offsetTop < 410*3/4){
			c2.fillStyle="yellow";
		}
		else{	    
			c2.fillStyle="red";			
		...
		if (event.x - board.offsetLeft > 650*3/4 && event.x - board.offsetLeft < 1050*3/4 && event.y - board.offsetTop > 500*3/4 && event.y - board.offsetTop < 560*3/4){
			c2.fillStyle="yellow";
		}
		else{	    
			c2.fillStyle="red";			
		...
		if (event.x - board.offsetLeft > 650*3/4 && event.x - board.offsetLeft < 1050*3/4 && event.y - board.offsetTop > 650*3/4 && event.y - board.offsetTop < 710*3/4){
			c2.fillStyle="yellow";
		}
		else{	    
			c2.fillStyle="red";			
		...
		if (event.x - board.offsetLeft > 650*3/4 && event.x - board.offsetLeft < 1050*3/4 && event.y - board.offsetTop > 800*3/4 && event.y - board.offsetTop < 860*3/4){
			c2.fillStyle="yellow";
		}
		else{	    
			c2.fillStyle="red";			
		...
		c2.font="50px Verdana";
	    if (event.x - board.offsetLeft > 800*3/4 && event.x - board.offsetLeft < 1000*3/4 && event.y - board.offsetTop > 250*3/4 && event.y - board.offsetTop < 310*3/4){		    
			c2.fillStyle="yellow";
		}
		else{
			c2.fillStyle="red";	
		...
		c2.fillText("Resume",800,300);
		if (event.x - board.offsetLeft > 800*3/4 && event.x - board.offsetLeft < 920*3/4 && event.y - board.offsetTop > 350*3/4 && event.y - board.offsetTop < 410*3/4){
			c2.fillStyle="yellow";
		}
		else{
			c2.fillStyle="red";	
...
board.addEventListener("mousedown", function(event){
    ...
    if (!paused && !mainy) {
		...
		if (event.x - board.offsetLeft > 800*3/4 && event.x - board.offsetLeft < 920*3/4 && event.y - board.offsetTop > 350/2 && event.y - board.offsetTop < 410*3/4){
		    mainy = true;
			clear();
			menu();
		}
...
var Wrack = function(x, y, a, Num){
	...
	this.image.src = "Graphics/wrack" + Num + ".png";
	this.set = function() {
...
var Item = function(x, y, Num) {
    ...
    this.type = Num;
	this.image = new Image();
	this.image.src = "Graphics/item" + Num + ".png";
...
var Bullet = function(x, y, xx, yy, Num) {
	...
	this.count = 0;
	this.image = new Image();
	this.image.src = "Graphics/bullet" + Num + ".png";
...
var Explosion = function(x, y, i, e, p, angle) {
	...
	this.index = i;
	this.ending = e;
	this.image.src = "Graphics/" + this.index + ".png";
...
var House = function(x, y, angle, Num) {
	...
	this.image = new Image();
	this.image.src = "Graphics/house" + Num + ".png";
...
var Turret = function (x, y, Num) {
	...
	this.type = Num;
    this.image = new Image();
	this.image.src = "Graphics/turret" + this.type + ".png";
    this.dirX = 0.0;
	this.dirY = -1.0;
	this.PosX = x;
	this.PosY = y;
...
var Tank = function (posX, posY, Num, d) {
	...
	this.smokecount = 100;
    this.image = new Image();	
    this.image.src = "Graphics/tank" + Num + ".png";	
    this.image2 = new Image();	
    this.image2.src = "Graphics/" + this.smokecount + ".png";	
	this.posX = posX;
	this.posY = posY;
...
var level1 = function () {
	"use strict";
	currentlevel = 1;
	board.style.background = "url('Graphics/grass3.jpg') repeat";
...
var level3 = function () {
	"use strict";
	currentlevel = 3;
	board.style.background = "url('Graphics/dirt.jpg') repeat";
...
var menu = function() {
	"use strict";
    board.style.background = "url('Graphics/military.jpg')";
